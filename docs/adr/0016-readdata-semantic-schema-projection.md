...
日期：2026-09-09
状态：已接受；交付条款由 [ADR-0027](0027-readdata-projection-text.md) 修订（投影体四件套退出公共读面、交付形态改为投影文本、每次读投影深拷贝条款退役），语义面条款（三元组动机、always-on、null 单义、解析语义、docs 文法、#359 可见性切片）原文延续——指针见「结果形状」「投影体」「交付纪律」各节与文末修订节。
