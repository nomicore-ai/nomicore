...
- **Typed access** — generating `generated.ts`, wiring TypeScript, or implementing namespace read/write code (including shape-budget reads with `depth` / `maxChildrenPerNode`): read [typed-access.md](typed-access.md).
