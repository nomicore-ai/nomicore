...
- **App data-access skill** — after integration, creating the host project's thin local skill for day-to-day data access (namespace inventory, write discipline, version facts, failure quick-reference) without duplicating mechanism docs or schema 口径: read [docs/integration/app-data-access-skill.md](../../../docs/integration/app-data-access-skill.md).
