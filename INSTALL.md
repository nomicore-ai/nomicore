# Installing and Developing Nomicore

English | [中文](INSTALL_zh.md)

This document covers installation, local package builds, publication, deployment, and repository development. For the project overview and motivating examples, see the [README](README.md).
